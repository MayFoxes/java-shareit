...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findAllByBookerIdAndStatus(Long booker, BookingStatus status, Pageable page);

    List<Booking> findAllByBookerIdAndStatus(Long booker, BookingStatus status, Sort sort);

    List<Booking> findAllByItemOwner(Long itemOwner, Pageable page);

    List<Booking> findAllByItemOwner(Long itemOwner, Sort sort);

    List<Booking> findAllByItemOwnerAndStatus(Long itemOwner, BookingStatus status, Pageable page);
