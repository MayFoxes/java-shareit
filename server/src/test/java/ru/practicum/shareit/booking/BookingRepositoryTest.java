...
class BookingRepositoryTest {
    ...
    void getAllByBookerAndStatusTest() {
        Booking received = bookingRepository.findAllByBookerAndStatus(user2, BookingStatus.APPROVED, sort).get(0);
    ...
    void getAllByItemOwnerAndStatusTest() {
        Booking received = bookingRepository.findAllByItemOwnerAndStatus(user2, BookingStatus.APPROVED, sort).get(0);
